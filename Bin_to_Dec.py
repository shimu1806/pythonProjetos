...
"""
print("CONVERSOR ATUALIZADO 2023 PARA CONVERTER NUMERO BINARIO EM DECIMAL, HELL YEAH\n\n")
...
while n >= 0: # o ciclo encerra quando o binario for totalmente operado
        resto = binario % 10 # sabendo que o resultado sempre será 1 ou 0, podemos utilizar o resto ao invés de montar o cód em vetor
        print("\no resto deu: ", resto)
...
print("\n\no binario que que você digitou foi: {}\nque representa o valor: {} em decimal".format(valorDigitado,decimal))
